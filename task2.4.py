...
def task_task_3(username_3, repos_name):
    try:
...
while True:
    ...
    variant = input(":")
    if variant == "1":
        task_task_1(username)
    elif variant == "2":
        task_task_2(username)
    elif variant == "3":
        repositories_name = input("введите название репозитория: ")
        task_task_3(username, repositories_name)
    elif variant == "4":
